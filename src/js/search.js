                ...
                <div className="result-area">
                    ...
                    <TabPanel>
                        <ul className="songs-item">
                        {
                            songs.map((data, k) => {
                                return (
                                    <li key={k} onClick={this.songSelect.bind(this)}>
                                        ...
                                        <div className="coum coum-2">
                                            <div className="c-w">
                                            <span className="play iconfont icon-bofang1" onClick={this.playSong.bind(this, data)}></span>
                                            <span className="more iconfont icon-caidan"></span>
